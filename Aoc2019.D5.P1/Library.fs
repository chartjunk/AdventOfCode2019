...
module IntCode2 =
    ...
    let jumpIfOp f mps p1 p2 pos mem = let r p i = read p (mode mps i) mem in match r p1 1 |> f with | true -> r p2 2 | _ -> pos + 3
    ...
    let execute input =
        let rec executeRec output pos mem =
            ...
            | _  ->
                ...
                | o&(5|6), p1::p2::_         -> output, jumpIfOp (match o with | 5 -> (<>)0 | _ -> (=)0) mps p1 p2 pos mem, mem
                |||> executeRec
